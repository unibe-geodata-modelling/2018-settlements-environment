...
***************************************************************************************************************************************************************
Calculating the percentage of the different sections/polygons (=different soil suitabilities) of the soil suitability map inside the buffers (lines 118 to 121)
***************************************************************************************************************************************************************
...
In the last input in the bracket of the function you have to change the field names. In this case the field name for the soil suitability was "Eignungsei" and for the settlements "Fundort".
You have to replace this with your correspondending field names.



*************************************************************************************************************************************************
Statistics  analysis - Calculating the mean land coverage and the standard deviation per settlment/buffer per soil suitability (line 154 and 157)
*************************************************************************************************************************************************
