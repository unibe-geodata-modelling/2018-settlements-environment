...
#*********************************************
#Intersect the buffers with the lake shapefile
#*********************************************
...
#Intersect function: The buffers are intersected with the lake shapefile
...
#*********************************************************************************************************
#Adding the field "Percent" and calculate area for the newly created shapefile from the intersect function
#*********************************************************************************************************
...
arcpy.CalculateField_management(interLake100, "Percent", "[POLY_AREA] /31374.937*100", "VB", "") #The Area of the lake polygon or polygons inside the buffers is divided by the whole buffer area and multiplied by 100 to receive the percentage of lake coverage per polygon
...
dfLakeArea100= LakeAreadbf100.to_dataframe() #Convert the dBase file into a data frame
plt.hist(dfLakeArea100["SUM_Percen"],bins=56) #Command for a histogram and how many bars you want to have maximally displayed. In this case 56 were chosen because there are 56 settlements.
plt.xlabel("%") #Here you set the title of the x-axis
...
dfLakeArea500= LakeAreadbf500.to_dataframe() #Convert dBase file into a data frame
plt.hist(dfLakeArea500["SUM_Percen"],bins=56) #Command for a histogram and how many bars you want to have maximally displayed. In this case 56 were chosen because there are 56 settlements.
plt.xlabel("%") #Here you set the title of the x-axis
plt.ylabel ("number of villages") #Here you set the title of the y-axis
...
LakeAreadbf1000= Dbf5(SumLakeBuff1000) #Convert dBase file into a data frame
dfLakeArea1000= LakeAreadbf1000.to_dataframe() #Convert dBase file into a data frame
plt.hist(dfLakeArea1000["SUM_Percen"],bins=56) #Command for a histogram and how many bars you want to have maximally displayed. In this case 56 were chosen because there are 56 settlements.
plt.xlabel("%") #Here you set the title of the x-axis
plt.ylabel ("number of villages") #Here you set the title of the y-axis
...
LakeAreadbf5000= Dbf5(SumLakeBuff5000) #Convert dBase file into a data frame
dfLakeArea5000= LakeAreadbf5000.to_dataframe() #Convert dBase file into a data frame
plt.hist(dfLakeArea5000["SUM_Percen"],bins=56) #Command for a histogram and how many bars you want to have maximally displayed. In this case 56 were chosen because there are 56 settlements.
plt.xlabel("%") #Here you set the title of the x-axis
plt.ylabel ("number of villages") #Here you set the title of the y-axis
...
statisticsLake100dbf= Dbf5(myworkspace + "/" + "Results" + "/" "StatisticsLake100.dbf") #Convert the dBase file into a data frame
statisticsLake100= statisticsLake100dbf.to_dataframe() #Convert dBase file into a data frame
statisticsLake100mean= statisticsLake100["MEAN_SUM_P"] #Setting the variable of the mean
statisticsLake100std= statisticsLake100["STD_SUM_Pe"] #Setting the variable of the standard deviation
...
statisticsLake500dbf= Dbf5(myworkspace + "/" + "Results" + "/" "StatisticsLake500.dbf") #Convert the dBase file into a data frame
statisticsLake500= statisticsLake500dbf.to_dataframe() #Convert the dBase file into a data frame
statisticsLake500mean= statisticsLake500["MEAN_SUM_P"] #Setting the variable of the mean
statisticsLake500std= statisticsLake500["STD_SUM_Pe"] #Setting the variable of the standard deviation
...
statisticsLake1000dbf= Dbf5(myworkspace + "/" + "Results" + "/" "StatisticsLake1000.dbf") #Convert the dBase file into a data frame
statisticsLake1000= statisticsLake1000dbf.to_dataframe() #Convert the dBase file into a data frame
statisticsLake1000mean= statisticsLake1000["MEAN_SUM_P"] #Setting the variable of the mean
statisticsLake1000std= statisticsLake1000["STD_SUM_Pe"] #Setting the variable of the standard deviation
...
statisticsLake5000dbf= Dbf5(myworkspace + "/" + "Results" + "/" "StatisticsLake5000.dbf")  #Convert the dBase file into a data frame
statisticsLake5000= statisticsLake5000dbf.to_dataframe() #Convert the dBase file into a data frame
statisticsLake5000mean= statisticsLake5000["MEAN_SUM_P"] #Setting the variable of the mean
statisticsLake5000std= statisticsLake5000["STD_SUM_Pe"] #Setting the variable of the standard deviation
